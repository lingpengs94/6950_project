...
```{r,echo=FALSE,fig.cap="Distribtuion of RMSE"}
set.seed(6950)
...
```{r echo = FALSE, message = F, warning = F, fig.height = 6,fig.cap="Model Diagnosis"}

model_diag =augment(fit.BIC.bw, fifa_model) %>% 
  mutate(.ti = rstudent(fit.BIC.bw))
base = model_diag %>% 
...
```{r,echo=FALSE, warning= FALSE,message = FALSE, fig.cap="Appendeix 1: Distribution of response",fig.height=5,fig.width=10, fig.align = "center"}
density_orign = 
